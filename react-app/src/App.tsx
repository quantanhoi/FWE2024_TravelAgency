  ...
  */ 
  useEffect(() => {
    fetch('http://localhost:3001/api/reise', {
      headers: {
        'Authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVkd2FyZDYxMTE5OTlAZ21haWwuY29tIiwibmFtZSI6IlRydW5nIFRoaWV1IiwiaWF0IjoxNzE2MjYyMTQzLCJleHAiOjE3MTYyNjU3NDMsImlzcyI6Imh0dHA6Ly9md2UuYXV0aCJ9.4Kp9AwGleZKxkB-i7YwZN_u1vCAYw4eeZEVGwRkyqL8'
      }
    })
